...
Note that the terminology used in this paper sometimes differs from common usage.
...
\textbf{Cotransmission.}  Occurs when a host or a vector is carrying a mixture of parasite alleles with different ancestral histories, subsequent to an episode of superinfection.
